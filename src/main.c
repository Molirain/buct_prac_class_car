...
/* Definitions for task_dfs */
osThreadId_t task_dfsHandle;
const osThreadAttr_t task_dfs_attributes = {
  .name = "task_dfs",
  .stack_size = 8192 * 4,
  .priority = (osPriority_t) osPriorityHigh,
};
...
int main(void)
{
  ...
  task_sensorHandle = osThreadNew(SensorTaskEnter, NULL, &task_sensor_attributes);

  /* creation of task_dfs */
  task_dfsHandle = osThreadNew(DFSTaskEntry, NULL, &task_dfs_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, TRIG_FRONT_Pin|TRIG_LEFT_Pin|TRIG_RIGHT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BTN_START_Pin BTN_SEND_Pin */
  GPIO_InitStruct.Pin = BTN_START_Pin|BTN_SEND_Pin;
...
/**
  ...
  * @retval None
  */
/* USER CODE END Header_MotorTaskEnter */
void MotorTaskEnter(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
...
/* USER CODE BEGIN Header_SensorTaskEnter */
/**
* @brief Function implementing the task_sensor thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_SensorTaskEnter */
void SensorTaskEnter(void *argument)
{
...
/* USER CODE BEGIN Header_DFSTaskEntry */
/**
* @brief Function implementing the task_dfs thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_DFSTaskEntry */
void DFSTaskEntry(void *argument)
{
...
/* USER CODE BEGIN Header_CommTaskEnter */
/**
* @brief Function implementing the task_comm thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_CommTaskEnter */
void CommTaskEnter(void *argument)
{
